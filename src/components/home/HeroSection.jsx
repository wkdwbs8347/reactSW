    ...
    overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-3xl px-6">
        ...
        <button
          ...
          className="px-8 py-3 rounded-2xl border border-primary text-primary font-semibold hover:bg-primary/10 transition"
        >
          서비스 소개
        </button>
      </div>
      ...
      <style>{`
        ...
        .animate-blob-slow {
          animation: blobSlow 18s infinite ease-in-out;
        }

        .animate-blob-medium {
          animation: blobMedium 14s infinite ease-in-out;
        }

        .animate-blob-fast {
          animation: blobFast 10s infinite ease-in-out;
        }
      `}</style>
    </section>
  );
